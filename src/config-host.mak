...
libs_softmmu=-lpixman-1   -lutil -lnuma  -lpng12   -ljpeg -lSDL   -lX11    
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.2.91
PKGVERSION=
SRC_PATH=/home/shkang/workspace/tqsim
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/shkang/workspace/tqsim/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
