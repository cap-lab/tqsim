...
DEF_HELPER_3(hsim_print2, void, env, i32, i32)

#define __GEN_HSIM_LDHEADER(type)   \
DEF_HELPER_2(hsim_ld##type, i32, env, i32)  

#define __GEN_HSIM_STHEADER(type)   \
DEF_HELPER_3(hsim_st##type, void, env, i32, i32)
	
#ifdef CONFIG_HSIM
__GEN_HSIM_LDHEADER(8s)
__GEN_HSIM_LDHEADER(8u)
__GEN_HSIM_LDHEADER(16s)
__GEN_HSIM_LDHEADER(16u)
__GEN_HSIM_LDHEADER(32u)

__GEN_HSIM_STHEADER(8)
__GEN_HSIM_STHEADER(16)
__GEN_HSIM_STHEADER(32)

DEF_HELPER_2(hsim_ld64, i64, env, i32)
DEF_HELPER_3(hsim_st64, void, env, i64, i32)
DEF_HELPER_2(hsim_isshared, i32, env, i32)
